...
DMatrix3<TType, EMatMajor::Column> DMatrix3<TType, EMatMajor::Column>::Transpose() const noexcept
{
  return DMatrix3
  {
    this->__mValues[0][0], this->__mValues[0][1], this->__mValues[0][2],
    this->__mValues[1][0], this->__mValues[1][1], this->__mValues[1][2],
    this->__mValues[2][0], this->__mValues[2][1], this->__mValues[2][2]
  };
}
...
DMatrix3<TType, EMatMajor::Row> DMatrix3<TType, EMatMajor::Row>::Transpose() const noexcept
{
  return DMatrix3
  {
    this->__mValues[0][0], this->__mValues[1][0], this->__mValues[2][0],
    this->__mValues[0][1], this->__mValues[1][1], this->__mValues[2][1],
    this->__mValues[0][2], this->__mValues[1][2], this->__mValues[2][2]
  };
}
